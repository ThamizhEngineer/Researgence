...
export var saleChartData: Array<any> = [{ data: [0, 2.25, 1.25, 3, 1.25, 2.25, 0] }];
...
export var lineChartData1: Array<any> = [{data:[20, 33, 20, 50, 20, 33, 20, 0]}];
...
export var lineChartData2: Array<any> = [{data:[5, 0, 5, 0, 15, 0, 5, 0, 5]}];
...
export var staticChartData: Array<any> = [{data:[1.000000000, 0.642787610, -0.173648178, -0.866025404, -0.939692621, -0.342020143, 0.500000000, 0.984807753]}];
